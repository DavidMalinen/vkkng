 ...
 */
export function Room({ highlight }: RoomProps): ReactElement {
  return (
 ...
 */
export const Shadows: React.FC = memo(() => (
...
export function EnvironmentWrapper({ intensity, highlight }: EnvironmentWrapperProps): ReactElement {
  return (
